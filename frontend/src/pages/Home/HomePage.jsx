...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-5 mx-auto">
    <div class="flex flex-wrap -m-4 text-center">
      ...
      <div class="p-4 sm:w-1/4 w-1/2">
        <h2 class="title-font font-medium sm:text-4xl text-3xl text-gray-900">20+</h2>
      ...
      <div class="p-4 sm:w-1/4 w-1/2">
        ...
        <p class="leading-relaxed">Post per Week</p>
      </div>
    </div>
  </div>
</section> */}
...
<section class="text-gray-600 body-font">
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    ...
    <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      ...
      {/* <p class="mb-8 leading-relaxed text-justify">
      At Esyventra, AI is a smart university event management platform designed to simplify how societies organize, promote, and analyze their events.From automated caption writing and flyer generation to centralized scheduling, our system ensures every event gets the attention it deserves.
      </p> */}
      <div class="flex justify-center">
